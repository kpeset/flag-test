      ...
      <div className="form">
        ...
        <div className="btn-area">
          <div className="btn-form">
            <button className="btn-subscribe" onClick={redirectRegister}>S'INSCRIRE</button>
          </div>
        </div>
        <div className="illustrations">
          ...
          <p>
            Les drapeaux n'ont aucun secrets pour toi? Tu connais les capitales
            sur le bout des doigts? Alors Earthathon est fait pour toi.
          </p>
          <img alt="médailles" src={medalspic} />
          <h3>Monte dans le classement</h3>
          <p>
            Crée toi un compte, enchaine les parties, améliore tes connaissances
            et grimpe dans le classement pour décrocher la médaille !
          </p>
        </div>
      </div>
    </div>
